...
const EditRecipePage = ({ editRecipeSubmit }) => {
    ...
    useEffect(() => {
        if (recipe) {
            ...
            setMadeBefore(recipe.madeBefore || false);
        }
    }, [recipe]); // Update form fields when recipe is loaded
      ...
      <div className="container m-auto max-w-2xl py-24">
        <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
          <form onSubmit={submitForm} >
            ...
            <div className="mb-4">
                <label htmlFor="type" className="block text-gray-700 font-bold mb-2">Meal Type</label>
              <select
                id="type"
                name="type"
